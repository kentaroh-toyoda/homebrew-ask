class Ask < Formula
  ...
  resource "certifi" do
    ...
    sha256 "b650d30f370c2b724812bee08008d0d6878bbe0c8e6bd0df28a5c4c96c94c018"
  end
  ...
  resource "pygments" do
    url "https://files.pythonhosted.org/packages/9e/a0/d16b3ad8c1c40d56cc88c5c4b4c4292bfcafe29a71eeb3ad4c1b2d7d5c79/pygments-2.19.1.tar.gz"
  ...
  resource "wcwidth" do
    url "https://files.pythonhosted.org/packages/6c/63/53559446a878410fc5a1b98bd934b31d1f3af6a5b2f4c05a3e4b8c2cd2bf/wcwidth-0.2.13.tar.gz"
  ...
  test do
    # Test that the ask command exists and shows help
    assert_match "Terminal GPT", shell_output("#{bin}/ask --help 2>&1", 0)
  end
end
